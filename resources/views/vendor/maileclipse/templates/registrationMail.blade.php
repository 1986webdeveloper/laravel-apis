...
<div class="content"><span class="brand"> <a href="#"> {{ $company_name }}</a></span></div>
</td>
</tr>
</tbody>
</table>
...
<tbody>
<tr>
<td class="status-cell">Mobile Number: <strong>{{ $mobile_number }}</strong></td>
</tr>
</tbody>
</table>
</td>
...
<div class="body-title">Hey {{ $first_name }} {{ $last_name }}, thanks for signing up</div>
